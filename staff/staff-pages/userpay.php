...
<div id="header">
  <h1><a href="dashboard.php">GYM BILOG CLUB</a></h1>
</div>
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GBC_<?php echo(rand(100000,10000000));?> <br> 5000  Iloilo City, <br>Philippines </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
