...
<html lang="en">
<head>
<title>GymBilog Club Staff A/C</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Home" class="tip-bottom"><img src="../img/iconhome.png" alt="">  Home</a> <a href="payment.php">Payments</a> <a href="#" class="current">Search Results</a> </div>
    <h1 class="text-center">Registered Member's Payment <img src="../img/verified-user.png" alt=""></h1>
  </div>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody>          
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn bg_ng btn-big'><strong>Make Payment</strong></button></a></div></td>
