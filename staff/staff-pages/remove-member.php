...
<body>
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Home" class="tip-bottom"><img src="../img/iconhome.png" alt="">  Home</a> <a href="remove-member.php" class="current">Remove Members</a> </div>
            <h1 class="text-center">Remove Members <img src="../img/remove.png" alt=""></h1>
        </div>
                    ...
                    <div class='widget-box'>
                        ...
                        <div class='widget-content nopadding'>
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                <td><div class='text-center bg_rd'><a href='actions/delete-member.php?id=".$row['user_id']."' style='color:#fff; font-weight:bold;' onclick='return confirm(\"Are you sure you want to delete this member?\")'> Remove</a></div></td>
                                </tbody>";
                                $cnt++;
                            }
                            ?>
