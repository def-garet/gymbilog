...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Home" class="tip-bottom"><img src="img/iconhome.png" alt=""> Home</a><a href="announcement.php">Announcement</a> <a href="#" class="current">Manage Announcement</a> </div>
    <h1 class="text-center">Manage Announcement <img src="img/loudspeaker.png" alt=""></h1>
  </div>
