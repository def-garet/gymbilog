...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Home" class="tip-bottom"><img src="img/iconhome.png" alt=""> Home</a> <a href="members.php" class="tip-bottom">Manage Members</a> <a href="" class="current">Update Members</a> </div>
            ...
            <div class="control-group">
              ...
              <div class="controls" id="cntrls">
                <label>
                  ...
                  Fitness <small>- Php100 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- Php120 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- Php100 per month</small></label>
              </div>
            </div>
