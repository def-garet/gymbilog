                    ...
                    <div class='widget-box'>
                        ...
                        <div class='widget-content nopadding'>
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                <td><div class='text-center bg_rd'><a href='actions/delete-member.php?id=".$row['user_id']."' onclick='return confirm(\"Are you sure you want to delete this member?\")'> Remove</a></div></td>
                                </tbody>";
                                $cnt++; 
                            }
                            ?>
