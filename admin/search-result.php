        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn bg_ng btn'> <strong>Make Payment</strong></button></a></div></td>
