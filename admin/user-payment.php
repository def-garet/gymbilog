              ...
              <div class="span7">
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    <tr>
                    <tr>
                      <td class="width30" style="font-weight:700;">Member's Fullname:</td>
                      <input type="hidden" name="fullname" value="<?php echo $row['fullname']; ?>">
                      <td class="width70" style="font-weight:700;"><strong><?php echo $row['fullname']; ?></strong></td>
                    </tr>
                    <tr>
                      <td style="font-weight:700;">Service:</td>
                      <input type="hidden" name="services" value="<?php echo $row['services']; ?>">
                      <td style="font-weight:700;"><strong><?php echo $row['services']; ?></strong></td>
                    </tr>
                    <tr>
                      <td style="font-weight:700;">Amount Per Month:</td>
                  ...
                  <td class="width30" style="font-weight:700;">Plan:</td>
                    <td class="width70">
					<div class="controls">
                <select name="plan" required="required" id="select">
                  ...
                  <td class="width30" style="font-weight:700;">Member's Status:</td>
                    <td class="width70">
					<div class="controls">
