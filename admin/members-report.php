...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">View Reports <img src="img/reports.png" alt=""></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover bg_sv'>
           ...
           <tbody> 
                ...
                <td><div class='text-center bg_pp'><a href="view-member-report.php?id= <?php echo $row['user_id'] ?>"> View Report</a></div></td>
