...
<html lang="en">
<head>
<title>GymBilog System Admin</title>
<meta charset="UTF-8" />
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Home" class="tip-bottom"><img src="img/iconhome.png" alt=""> Home</a> <a href="payment.php" class="tip-bottom">Payment</a> <a href="#" class="current">Make Payments</a> </div>
                    ...
                    <td class="container" width="600">
                        <div class="content">
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GBC_<?php echo(rand(100000,10000000));?> <br> Iloilo City, <br>Philippines </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
                            ...
                            <div class="footer">
                                <table width="100%">
                                    <tbody><tr>
                                        <td class="aligncenter content-block"><button class="btn bg_hp" onclick="window.print()"><strong>Print</strong></button></td>
                                    </tr>
                                </tbody></table>
                            </div></div>
                    </td>
