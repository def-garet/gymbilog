...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Home" class="tip-bottom"><img src="img/iconhome.png" alt=""> Home</a> <a href="#" class="tip-bottom">Manage Members</a> <a href="#" class="current">Add Members</a> </div>
...
if (isset($_POST['fullname'])) {
  ...
  //para makwa ko kung pila balaydan ni user
  $totalamount = $amount * $plan;

  // para makaadd members sa db, may gin change lang ko kay wala gasulod
  include 'dbcon.php';
